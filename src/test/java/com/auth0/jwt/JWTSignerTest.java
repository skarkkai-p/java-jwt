...
public class JWTSignerTest {
    ...
    @Test
    public void shouldEncodeEmpty() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
        String token = signer.encode(claims, "my secret", Algorithm.HS256);
        assertEquals("eyJ0eXBlIjoiSldUIiwiYWxnIjoiSFMyNTYifQ.e30.22wExCVEVtV1rZU51TB9W64deZc_ZN7mc_Z1Yq0dmo0", token);
    }

    @Test
    public void shouldEncodeStringOrURI1() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
        claims.put("iss", "foo");
        String token = signer.encode(claims, "my secret", Algorithm.HS256);
    ...
    @Test
    public void shouldEncodeStringOrURI2() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
    ...
    @Test
    public void shouldEncodeStringOrURI3() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
        claims.put("aud", "");
        String token = signer.encode(claims, "my secret", Algorithm.HS256);
    ...
    @Test
    public void shouldEncodeStringOrURICollection() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
    ...
    @Test
    public void shouldEncodeIntDate1() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
        claims.put("exp", 123);
        String token = signer.encode(claims, "my secret", Algorithm.HS256);
    ...
    @Test
    public void shouldEncodeIntDate2() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
        claims.put("nbf", 0);
        String token = signer.encode(claims, "my secret", Algorithm.HS256);
    ...
    @Test
    public void shouldEncodeIntDate3() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
    ...
    @Test
    public void shouldEncodeString() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
        claims.put("jti", "foo");
        String token = signer.encode(claims, "my secret", Algorithm.HS256);
    ...
    @Test
    public void shouldEncodeNullEqualsMissing() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
    ...
    public void shouldFailExpectStringOrURI1() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
        claims.put("iss", 0);
        signer.encode(claims, "my secret", Algorithm.HS256);
    }
