...
public class JWTSignerTest {
    ...
    public void shouldSignEmpty() throws Exception {
        ...
        String token = signer.sign(claims, "my secret", Algorithm.HS256);
    ...
    public void shouldFailExpectStringOrURI1() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
        claims.put("iss", 0);
        signer.sign(claims, "my secret", Algorithm.HS256);
    }
    ...
    @Test
    public void shouldOptionExp() throws Exception {
        HashMap<String, Object> claims = new HashMap<String, Object>();
        signer.sign(claims, "my secret", Algorithm.HS256,
                new JWTSigner.Options().setExpirySeconds(10));
    }
}
